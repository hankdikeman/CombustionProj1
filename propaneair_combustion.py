...
if __name__ == "__main__":
    ...
    flametitle = 'Adiabatic Flame Temperature as a Function of Phi'
    flameytitle = 'Flame Temperature (K)'
    # plot temps vs phi using matplotlib
    plot_phitemps(equivs, flametemps, flametitle, flameytitle)

    combtitle = 'Adiabatic Combustion Temperature as a Function of Phi'
    combytitle = 'Combustion Temperature (K)'
    combptitle = 'Adiabatic Combustion Pressure as a Function of Phi'
